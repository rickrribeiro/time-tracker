...
export type Page = 'timeline' | 'calendar' | 'tags' | 'dashboard' | 'tasks' | 'home' | 'inbox' | 'todo' | 'habits' | 'projects' | 'issues' | 'finance-dashboard' | 'transactions' | 'budget' | 'investments' | 'reports' | 'trips' | 'trip-monitoring' | 'destinations' | 'documents' | 'recommendations' | 'settings';
declare global {
    interface Window {
        api: {
            tags: {
            ...
            tasks: {
                ...
                update: (id: number, title: string, tagId: number | null, secondaryTagId: number | null, startTime: string, endTime: string | null) => Promise<Task>;
                delete: (id: number) => Promise<void>;
                add: (title: string, tagId: number | null, secondaryTagId: number | null, startTime: string, endTime: string | null) => Promise<Task>;
            ...
            todos: {
                ...
                create: (title: string, notes: string | null, status: string, source: string, priority?: number, dueDate?: string | null, projectId?: number | null) => Promise<Todo>;
                update: (id: number, title: string, notes: string | null, status: string, priority: number, dueDate: string | null, projectId: number | null) => Promise<Todo>;
                delete: (id: number) => Promise<void>;
            };
            projects: {
                getAll: () => Promise<Project[]>;
                create: (name: string, description: string | null, githubRepoUrl: string | null, color: string) => Promise<Project>;
                update: (id: number, name: string, description: string | null, githubRepoUrl: string | null, color: string, archived: number) => Promise<Project>;
                delete: (id: number) => Promise<void>;
            };
            habits: {
