...
const api = {
  ...
  study: {
    ...
    reviewFlashcard: (id, easeFactor, intervalDays, repetitions, nextReviewAt, lastReviewedAt, rating) => electron.ipcRenderer.invoke("study:reviewFlashcard", id, easeFactor, intervalDays, repetitions, nextReviewAt, lastReviewedAt, rating),
    reviewCountsByDay: (startISO, endISO) => electron.ipcRenderer.invoke("study:reviewCountsByDay", startISO, endISO),
